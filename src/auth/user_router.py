...
from hh.auth.dependencies.user.service import IUserService
from hh.auth.dto import BaseUserDTO, PublicUserDTO, PrivateUserDTO
...
async def register_user(user_data: BaseUserDTO, service: IUserService):
